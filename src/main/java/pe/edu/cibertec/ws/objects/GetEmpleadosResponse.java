 ...
 *       &lt;sequence&gt;
 *         &lt;element name="empleados" type="{http://www.cibertec.edu.pe/ws/objects}empleadow" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetEmpleadosResponse {
    ...
    protected List<Empleadow> empleados;
     ...
     * 
     */
    public List<Empleadow> getEmpleados() {
        if (empleados == null) {
            empleados = new ArrayList<Empleadow>();
        }
